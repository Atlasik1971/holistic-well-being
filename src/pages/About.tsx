          ...
          <div className="grid gap-12 lg:grid-cols-12 items-start">
            <div className="lg:col-span-5">
              ...
              <p className="mt-6 text-muted-foreground leading-relaxed">
                Я развиваюсь в сфере нутрициологии, регулярно прохожу профессиональное обучение и
                работаю с темами питания, режима и пищевых привычек в персональном формате.
              </p>
            </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      text: "Регулярное обучение и системный подход помогают мне разбирать сложные запросы и подбирать бережные рекомендации под реальную жизнь.",
                      backTitle: "Что это даёт в работе",
                      backText:
      ...
      <Section>
        <div className="container-wide">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-3">
            {[
              { k: "01", v: "Персональный разбор запроса" },
              { k: "02", v: "Пошаговые рекомендации" },
              { k: "03", v: "Поддержка в процессе изменений" },
            ].map((s) => (
